...
const CrossfadeImage = ({ fromUrl, toUrl, crossfadeFrame, crossfadeDuration, objectPosition = 'center top', imageFilter, currentSceneFrame, }) => {
...
export const TalkingHeadV2Template = ({ audioUrl, expertName, expertSpecialty, domain, hookText, hookStyle = 'zoom-face', hookStat, hookEmoji, toneTag, scenes, ctaText, ctaType, ctaTitle, ctaSubtitle, ctaLink, ctaHandle, accentColor: customAccent, bgGradientStart: customStart, bgGradientEnd: customEnd, bgSolid: customSolid, themeId = 'gold-clinical', bgVideoUrl: customBgVideo, language = 'en', expertAvatar, expertLogo, expertImages, expertImageSet, overlayStyle: customOverlayStyle, wordTimestamps, clientId, designId, fontPairingIndex: customFontPairingIndex, layoutVariant: customLayoutVariant, decorationStyle: customDecorationStyle, imageTreatment: customImageTreatment, }) => {
    ...
    return (_jsxs(AbsoluteFill, { children: [currentBgImage ? (_jsx(AbsoluteFill, { style: { overflow: 'hidden' }, children: isCrossfading ? (_jsx(CrossfadeImage, { fromUrl: prevBgImage, toUrl: currentBgImage, crossfadeFrame: frameWithinScene, crossfadeDuration: CROSSFADE_DURATION, imageFilter: resolvedImageFilter, currentSceneFrame: frameWithinScene })) : (_jsxs(AbsoluteFill, { style: { backgroundColor: '#0A0A0A', overflow: 'hidden' }, children: [_jsx(Img, { src: currentBgImage.startsWith('http') || currentBgImage.startsWith('data:') || currentBgImage.startsWith('/') || currentBgImage.startsWith('file:') ? currentBgImage : staticFile(currentBgImage), style: {
                                width: '100%',
                                height: '100%',
                                objectFit: 'cover',
                            ...
                            } }), resolvedOverlayStyle === 'scrim-bottom' && (_jsx(AbsoluteFill, { style: { background: 'linear-gradient(to bottom, transparent 0%, transparent 25%, rgba(0,0,0,0.55) 60%, rgba(0,0,0,0.85) 100%)', zIndex: 1 } })), resolvedOverlayStyle === 'scrim-full' && (_jsx(AbsoluteFill, { style: { background: 'rgba(0,0,0,0.38)', zIndex: 1 } })), resolvedOverlayStyle === 'vignette' && (_jsx(AbsoluteFill, { style: { background: 'radial-gradient(ellipse at 50% 35%, transparent 30%, rgba(0,0,0,0.65) 100%)', zIndex: 1 } })), _jsx(AbsoluteFill, { style: { background: 'linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, transparent 20%)', zIndex: 2 } })] })) })) : (_jsx(AnimatedBackground, { bgType: "hero-portrait", bgGradientStart: resolvedBgStart, bgGradientEnd: resolvedBgEnd, bgSolid: resolvedBgSolid, bgVideoUrl: resolvedBgVideo, overlayStyle: resolvedOverlayStyle, accentColor: resolvedAccent, imageFilter: resolvedImageFilter })), _jsx(SafeZone, { show: false }), resolvedLogoUrl && frame >= AUDIO_START_FRAME && (_jsx("div", { style: {
                    position: 'absolute',
                    top: '80px', right: '80px',
                    opacity: 0.8,
                    zIndex: 20,
