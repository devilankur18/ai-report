...
import { LayoutVariant, DecorationStyle, getQuoteCardPosition, getQuoteCardDecoration } from '../../lib/personalization';
...
export const PersonalizedQuoteCard: React.FC<PersonalizedQuoteCardProps> = ({
  variant,
  decoration,
  accentColor,
  textColor,
  ...
  return (
    ...
    >
      {decoration === 'quote-marks' && (
        <span style={{ color: accentColor, fontSize: '64px', lineHeight: 0, verticalAlign: 'middle', marginRight: '8px' }}>“</span>
      )}
      {children}
      {decoration === 'quote-marks' && (
        <span style={{ color: accentColor, fontSize: '64px', lineHeight: 0, verticalAlign: 'middle', marginLeft: '8px' }}>”</span>
      )}
    </div>
  );
};

interface PersonalizedIdentityProps {
  variant: LayoutVariant;
  expertName: string;
  ...
  textShadow: string;
  fontFamily: string;
  avatarResolver: (u?: string | null) => string;
}

export const PersonalizedIdentity: React.FC<PersonalizedIdentityProps> = ({
  variant,
  expertName,
  expertSpecialty,
  expertAvatar,
  ...
  return (
    <div style={alignStyle}>
      ...
      <div style={{ textAlign: variant === 'quote-top' ? 'center' : 'left' }}>
        <div style={{
          fontFamily,
          fontSize: '34px',
          fontWeight: 700,
