// Local type aliases matching AnimatedBackground — avoids circular import
export type BgType = 'gradient' | 'solid' | 'video' | 'particles' | 'image' | 'hero-portrait';
export type OverlayStyle = 'scrim-bottom' | 'scrim-full' | 'vignette' | 'none';
...
export interface ThemeConfig {
  ...
  bgSolid?: string;
  bgVideoUrl?: string;
  /** Controls how the scrim/overlay is applied over image/portrait backgrounds */
