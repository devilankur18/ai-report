            ...
            justifyContent: 'center',
                ...
                gap: '24px',
                        ...
                        paddingBottom: '20px',
                                ...
                                letterSpacing: '3px',
                            }, children: "EHR DIAGNOSTIC CASE FILE" }), isAlertVisible && (_jsx("div", { style: {
                            ...
                            }, children: "\u26A0\uFE0F ALERT: CRITICAL RISK" }))] }), _jsxs("div", { style: { display: 'flex', gap: '36px', alignItems: 'center' }, children: [_jsx("div", { style: {
                                width: '220px',
                                height: '220px',
                                borderRadius: '50%',
                            ...
                            }, children: doctorPhoto ? (_jsx(Img, { src: resolveUrl(doctorPhoto), style: { width: '100%', height: '100%', objectFit: 'cover' } })) : (_jsx("div", { style: { width: '100%', height: '100%', backgroundColor: `${accentColor}22` } })) }), _jsxs("div", { style: {
                                display: 'flex',
                                flexDirection: 'column',
                                gap: '12px',
                            ...
                            }, children: [_jsx("div", { children: patientIdText }), _jsx("div", { style: { color: statusText.includes('CRITICAL') ? '#FF3B30' : '#00FF66', textShadow: statusText.includes('CRITICAL') ? '0 0 8px rgba(255,59,48,0.4)' : 'none' }, children: statusText }), _jsx("div", { children: diagnosisText })] })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '16px', textAlign: 'left' }, children: [line1 && (_jsx("div", { style: {
...
export const RedactedHook = ({ doctorAvatar, doctorName, doctorTitle, hookText, accentColor, fonts }) => {
    const frame = useCurrentFrame();
    const { fps } = useVideoConfig();
    ...
    return (_jsxs(AbsoluteFill, { style: {
            ...
            transform: `translateX(${shakeX}px)`,
                    ...
                    marginTop: '120px',
                        ...
                        if (isRedacted) {
                            return (_jsxs("span", { style: { position: 'relative', marginRight: '16px', display: 'inline-block' }, children: [_jsx("span", { style: { opacity: isRevealed ? 1 : 0, color: '#FF3B30', textTransform: 'uppercase', fontWeight: 900 }, children: w }), !isRevealed && (_jsx("span", { style: {
                                            position: 'absolute',
                                            inset: 0,
                                            backgroundColor: '#111',
                                            borderRadius: '4px',
...
export const RedactedHookPreview = () => {
    return (_jsx(RedactedHook, { doctorAvatar: "clients/dr-priya-sharma/1780601853812-avatar-avatar.png", doctorName: "Dr. Priya Sharma", doctorTitle: "Dermatologist", hookText: "What private clinics [REDACTED] don\u2019t want you to know about insurance payouts.", accentColor: "#FF3B30", fonts: { sans: 'Outfit', serif: 'Playfair Display' } }));
};
